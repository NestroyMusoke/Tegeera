...
export const conceptRegistry: readonly ConceptDefinition[] = [
  { id: "person", kind: "person", category: "actor", singular: "person", plural: "people", aliases: ["persons"], glyphKey: "person", countable: true, capabilities: ["human-performance", "walk"] },
  { id: "student", kind: "student", category: "actor", singular: "student", plural: "students", aliases: ["learner", "learners"], glyphKey: "student", countable: true, capabilities: ["human-performance", "walk"] },
  { id: "teacher", kind: "teacher", category: "actor", singular: "teacher", plural: "teachers", aliases: ["lecturer", "lecturers"], glyphKey: "teacher", countable: true, capabilities: ["human-performance", "walk"] },
  { id: "process", kind: "process", category: "process", singular: "process", plural: "processes", aliases: [], glyphKey: "process", countable: true, capabilities: ["queue-member"] },
  { id: "cpu", kind: "cpu", category: "system", singular: "cpu", plural: "cpus", aliases: ["processor", "processors"], glyphKey: "cpu", countable: true, capabilities: ["queue-target"] },
  ...
  { id: "building", kind: "building", category: "place", singular: "building", plural: "buildings", aliases: ["school", "schools", "house", "houses"], glyphKey: "building", countable: true, capabilities: [] },
