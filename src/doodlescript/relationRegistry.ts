...
export const RELATION_REGISTRY_VERSION = "2.9.0";

export type RelationKind = SceneRelation["kind"];
export type RelationFamily = "structural" | "directional" | "ordered" | "performance" | "event" | "visual" | "compositional" | "mechanical" | "containment" | "measurement" | "landscape" | "circulation" | "kinematics" | "control-flow" | "arithmetic";
