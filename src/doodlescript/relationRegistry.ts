...
export const relationRegistry: readonly RelationDefinition[] = [
  ...
  { kind: "queuedFor", family: "ordered", label: "waits for CPU", aliases: [], minimumVersion: "1.4.0", source: { min: 1, max: 4 }, target: { min: 1, max: 1 }, object: { min: 0, max: 0 }, directed: true, layout: "queue" },
