...
export function validateDoodleScript(
  ...
  for (const command of script.commands) {
    ...
    if (changesPerformance && !["1.5.0", "1.6.0", "1.7.0", "1.8.0", "1.9.0", "2.0.0", "2.1.0", "2.2.0", "2.3.0", "2.4.0", "2.5.0"].includes(script.schemaVersion)) {
    ...
    if (command.action === "unrelate") {
      ...
      if (!["1.2.0", "1.3.0", "1.4.0", "1.5.0", "1.6.0", "1.7.0", "1.8.0", "1.9.0", "2.0.0", "2.1.0", "2.2.0", "2.3.0", "2.4.0", "2.5.0"].includes(script.schemaVersion)) issues.push({ gate: "schema", message: "Relationship edits require DoodleScript 1.2.0 or later." });
    ...
    if (command.action === "relate") {
      ...
      if (isMotion(relation)) {
        if (!["1.3.0", "1.4.0", "1.5.0", "1.6.0", "1.7.0", "1.8.0", "1.9.0", "2.0.0", "2.1.0", "2.2.0", "2.3.0", "2.4.0", "2.5.0"].includes(script.schemaVersion)) issues.push({ gate: "schema", message: "Directed motion requires DoodleScript 1.3.0 or later." });
      ...
      if (relation.kind === "actsOn") {
        if (!["1.6.0", "1.7.0", "1.8.0", "1.9.0", "2.0.0", "2.1.0", "2.2.0", "2.3.0", "2.4.0", "2.5.0"].includes(script.schemaVersion)) issues.push({ gate: "schema", message: "Targeted performances require DoodleScript 1.6.0 or later." });
      ...
      if (relation.kind === "handover") {
        if (!["1.7.0", "1.8.0", "1.9.0", "2.0.0", "2.1.0", "2.2.0", "2.3.0", "2.4.0", "2.5.0"].includes(script.schemaVersion)) issues.push({ gate: "schema", message: "Handovers require DoodleScript 1.7.0 or later." });
      ...
      if (isEventRelation(relation)) {
        if (!["1.8.0", "1.9.0", "2.0.0", "2.1.0", "2.2.0", "2.3.0", "2.4.0", "2.5.0"].includes(script.schemaVersion)) issues.push({ gate: "schema", message: "Event relationships require DoodleScript 1.8.0 or later." });
      ...
      if (isVisualAction(relation)) {
        if (!["1.9.0", "2.0.0", "2.1.0", "2.2.0", "2.3.0", "2.4.0", "2.5.0"].includes(script.schemaVersion)) issues.push({ gate: "schema", message: "Visual actions require DoodleScript 1.9.0 or later." });
        if (relation.sourceIds.length !== 1 || relation.targetIds.length !== 1 || !relation.predicate) {
  ...
  if (script.context) {
    if (!["1.2.0", "1.3.0", "1.4.0", "1.5.0", "1.6.0", "1.7.0", "1.8.0", "1.9.0", "2.0.0", "2.1.0", "2.2.0", "2.3.0", "2.4.0", "2.5.0"].includes(script.schemaVersion)) issues.push({ gate: "schema", message: "Conversation context requires DoodleScript 1.2.0 or later." });
