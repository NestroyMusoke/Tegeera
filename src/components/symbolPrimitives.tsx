...
const primitiveRenderers: Readonly<Record<SymbolPrimitive, PrimitiveRenderer>> = {
  ...
  plant: () => <g><path className="doodle-stroke" d="M0 35 C-2 13-1-11 0-35 M0-7 C-17-6-27-17-26-31 C-10-30-1-21 0-7 M0 7 C17 7 28-5 28-20 C12-19 2-9 0 7" /><path className="doodle-detail" d="M-14 31 Q0 22 15 31 M-20 36 Q0 27 21 36" /></g>,
  ...
  roots: () => <g><path className="doodle-stroke" d="M0-34 V-8 M0-8 C-4 8-18 15-25 34 M0-8 C5 9 17 17 24 35 M-7 5 C-18 8-28 17-34 27 M8 7 C20 10 29 19 34 29" /><path className="doodle-detail" d="M-19 18 L-31 16 M18 20 L30 18 M-8 11 L-14 27 M9 13 L13 30" /></g>,
