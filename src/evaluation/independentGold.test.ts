...
describe("independent semantic-scene gold annotations", () => {
  ...
  it("validates a unique, cross-domain first annotation batch", () => {
    ...
    expect(parsed.cases.map(({ id }) => id)).toEqual([1, 2, 11, 12, 21, 22, 24, 28, 31, 32, 41, 42, 3, 13, 23, 25, 29, 26, 27, 33, 44, 51, 53, 56, 60]);
  ...
  it("reports every dimension honestly without requiring the current engine to pass", () => {
    const result = evaluateIndependentGold(teacherCases, gold, {
      1: observeCase(1), 2: observeCase(2), 3: observeCase(3), 11: observeCase(11), 12: observeCase(12), 13: observeCase(13), 21: observeCase(21), 22: observeCase(22), 23: observeCase(23), 24: observeCase(24), 25: observeCase(25), 26: observeCase(26), 27: observeCase(27), 28: observeCase(28), 29: observeCase(29), 31: observeCase(31), 32: observeCase(32), 33: observeCase(33), 41: observeCase(41), 42: observeCase(42), 44: observeCase(44), 51: observeCase(51)
    });
    ...
    expect(result.automatedReady).toBe(25);
