...
2. Evaluate the **same independent 60 statements** through the hosted pipeline. Measure semantic completeness (required concepts and relationships), unsafe acceptance, clarification rate, service latency, and visual appearance separately. No model gets a pass merely for returning valid JSON.
